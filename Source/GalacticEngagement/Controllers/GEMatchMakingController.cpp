...
void AGEMatchMakingController::StartFindSession()
{
...
void AGEMatchMakingController::FindSessions(TSharedPtr<const FUniqueNetId> UserId, bool bIsLAN, bool bIsPresence)
{
...
bool AGEMatchMakingController::JoinSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName, const FOnlineSessionSearchResult& SearchResult)
{
	// Return bool
...
void AGEMatchMakingController::OnFindSessionsComplete(bool bWasSuccessful)
{
...
void AGEMatchMakingController::OnJoinSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	{
		// Get SessionInterface from the OnlineSubsystem
		...
		if (Sessions.IsValid())
		{
			...
			APlayerController * const PlayerController = this;
